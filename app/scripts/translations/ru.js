...
GEN_Warning_1                   :  '**Не потеряйте!** Он не может быть восстановлен в случае потери.',
GEN_Warning_2                   :  '**Не передавайте!** Ваши средства будут украдены в случае использования этого файла на ненадежных сайтах.',
GEN_Warning_3                   :  '**Сделайте резервную копию!** Храните его как миллион долларов которые он может стоить однажды.',
...
x_PasswordDesc              : 'Этот пароль * шифрует * закрытый ключ. **Вам понадобится пароль + закрытый ключ для получения доступа к вашему кошельку.**',
...
GEN_Help_12                 : 'Используйте его для получения доступа к кошельку через Wallet maincoin.money (или Mist, Geth, Parity и другие типа кошельков.) ',
...
REC_WAY_TXT                 : 'С помощью этой опции вы можете только посмотреть баланс. Для отправки токенов воспользуйтесь другой опцией.',
NOT_REC_WAY                 : 'Это <u>не</u> оптимальный путь доступа к вашему кошельку.',
Entering_Private_Key        : 'Ввод вашего закрытого ключа на веб сайте потенциально опасен. В случае, если наш сайт скомпрометирован или вы случайно посетили другой сайт, ваши средства могут быть украдены.',
If_You_Must                 : 'Если входите, то <u>дважды проверьте</u> адрес сайта и наличие SSL сертификата. Адрес должен быть https://wallet.maincoin.money/',
...
x_AddessDesc                : 'Это можно назвать "номер Вашего счёта" или "Ваш открытый ключ". Вы сообщаете этот адрес людям, чтобы они могли отправлять Вам maincoin (так и другие криптовалюты). Картинка позволяет легко опознать Ваш адрес среди других адресов. ',
x_Address                   : 'Ваш адрес ',
x_Cancel                    : 'Отменить ',
...
x_MetaMask_txt              : 'MetaMask это расширение браузера, которое позволяет быстро, легко и безопасно получить доступ к кошельку. Это безопасно потому что вам никогда не потребуется вводить закрытый ключ для доступа к кошельку. Это расширение защищает вас от ненадежных сайтов.',
...
Hardware_Wallet             : 'Аппаратный кошелек в виде маленького USB устройства, которое позволяет вам получит доступ к кошельку быстро, безопасно и легко. Это безопасно потому что ваш закрытый ключ никогда не покидает пределов аппаратного кошелька.',
Password                    : 'Пароль',
/* Error Messages */
